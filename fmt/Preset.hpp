...
namespace Preset {
    namespace SingBox {
        ...
        // ui/dialog_vpn_settings.ui (Mixed, gVisor, System) - the combo only
        // persists an integer index, mapped through this list to build the
        // sing-box "stack" value. These were out of sync (list was
        ...
        inline QStringList VpnImplementation = {"mixed", "gvisor", "system"};

...
void EditCustom::onStart(std::shared_ptr<Vload::ProxyEntity> _ent) {
    this->ent = _ent;
    auto bean = this->ent->CustomBean();

    // load known core
    auto core_map = QString2QJsonObject(Vload::dataStore->extraCore->core_map);
    ...
    connect(ui->preview, &QPushButton::clicked, this, [=] {
        ...
        // EditCustom::onEnd
        auto tmpEnt = Vload::ProfileManager::NewProxyEntity("custom");
        ...
        //
        auto result = Vload::BuildConfig(tmpEnt, false, false);

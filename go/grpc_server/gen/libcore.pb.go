...
const file_libcore_proto_rawDesc = "" +
	...
	"\tavailable\x18\x02 \x01(\bR\tavailable*2\n" +
	"\bTestMode\x12\v\n" +
	...
	"\x19UpdateNetworkAvailability\x12%.libcore.UpdateNetworkAvailabilityReq\x1a\x12.libcore.ErrorResp\"\x00B\x11Z\x0fgrpc_server/genb\x06proto3"
...
var file_libcore_proto_depIdxs = []int32{
	...
	12, // 17: libcore.LibcoreService.ListConnections:output_type -> libcore.ListConnectionsResp
	4,  // 18: libcore.LibcoreService.UpdateNetworkAvailability:output_type -> libcore.ErrorResp

...
const (
	...
	LibcoreService_UpdateNetworkAvailability_FullMethodName = "/libcore.LibcoreService/UpdateNetworkAvailability"
	LibcoreService_ResetSlotConnections_FullMethodName      = "/libcore.LibcoreService/ResetSlotConnections"
)
...
type LibcoreServiceClient interface {
	...
	UpdateNetworkAvailability(ctx context.Context, in *UpdateNetworkAvailabilityReq, opts ...grpc.CallOption) (*ErrorResp, error)
	...
	ResetSlotConnections(ctx context.Context, in *ResetSlotConnectionsReq, opts ...grpc.CallOption) (*ResetSlotConnectionsResp, error)
}
...
func (c *libcoreServiceClient) UpdateNetworkAvailability(ctx context.Context, in *UpdateNetworkAvailabilityReq, opts ...grpc.CallOption) (*ErrorResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ErrorResp)
	err := c.cc.Invoke(ctx, LibcoreService_UpdateNetworkAvailability_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *libcoreServiceClient) ResetSlotConnections(ctx context.Context, in *ResetSlotConnectionsReq, opts ...grpc.CallOption) (*ResetSlotConnectionsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResetSlotConnectionsResp)
	err := c.cc.Invoke(ctx, LibcoreService_ResetSlotConnections_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LibcoreServiceServer interface {
	...
	// bound to drops or recovers. No-op if the running config isn't using a
	// weighted (vload load-balance) outbound.
	UpdateNetworkAvailability(context.Context, *UpdateNetworkAvailabilityReq) (*ErrorResp, error)
	// vload: force-close every connection currently open on one load-balance
	// slot (0 or 1) - use when that slot's physical network adapter actually
	// changed underneath it (went down, or came back as a different link),
	// so whatever was using those connections fails fast and retries through
	...
	// is left untouched. No-op if the running config isn't using a weighted
	// (vload load-balance) outbound.
	ResetSlotConnections(context.Context, *ResetSlotConnectionsReq) (*ResetSlotConnectionsResp, error)
...
func (UnimplementedLibcoreServiceServer) UpdateNetworkAvailability(context.Context, *UpdateNetworkAvailabilityReq) (*ErrorResp, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateNetworkAvailability not implemented")
}
func (UnimplementedLibcoreServiceServer) ResetSlotConnections(context.Context, *ResetSlotConnectionsReq) (*ResetSlotConnectionsResp, error) {
	return nil, status.Error(codes.Unimplemented, "method ResetSlotConnections not implemented")
}
...
func _LibcoreService_UpdateNetworkAvailability_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateNetworkAvailabilityReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LibcoreServiceServer).UpdateNetworkAvailability(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LibcoreService_UpdateNetworkAvailability_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibcoreServiceServer).UpdateNetworkAvailability(ctx, req.(*UpdateNetworkAvailabilityReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _LibcoreService_ResetSlotConnections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResetSlotConnectionsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LibcoreServiceServer).ResetSlotConnections(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LibcoreService_ResetSlotConnections_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibcoreServiceServer).ResetSlotConnections(ctx, req.(*ResetSlotConnectionsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LibcoreService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateNetworkAvailability",
			Handler:    _LibcoreService_UpdateNetworkAvailability_Handler,
		},
		{
			MethodName: "ResetSlotConnections",
			Handler:    _LibcoreService_ResetSlotConnections_Handler,
		},
	},

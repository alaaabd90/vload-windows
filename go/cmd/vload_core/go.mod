...
require github.com/sagernet/sing v0.8.12
...
// replace github.com/sagernet/sing-quic => ../../../../sing-quic (MatsuriDayo/sing-quic's tags are stale vs current sing-box-vload; use upstream sagernet/sing-quic from the module proxy instead)
